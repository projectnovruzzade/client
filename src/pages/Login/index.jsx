      ...
      <div className="wrapper w-96 border-2 border-red-300 p-7 rounded-md">
        ...
        <form action="">
          <div className="input_content flex justify-center">
            <input type="text" placeholder="Email" className="w-full mb-4 px-1 py-1 outline-none border border-gray-400 rounded-md focus:border-blue-500 transition-all text-sm"/>
          </div>
          <div className="input_content flex justify-center">
